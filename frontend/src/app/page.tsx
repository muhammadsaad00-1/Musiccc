...
import { MessageSquare, Star, Quote, ArrowRight, Play, CheckCircle, XCircle, Loader2, Shield, Zap, HeartHandshake, Trophy } from 'lucide-react';
...
import { Mic2, Music, Globe, Award, Send, User, MapPin, Briefcase, Heart } from "lucide-react";
...
export default function Home() {
  ...
  // Auto-advance neon highlight for Why Choose Us
  useEffect(() => {
  ...
  const whyChooseUs = [
    {
      ...
      desc: "Every artist on our platform undergoes a rigorous 5-step background and talent verification process.",
      icon: Shield,
    ...
    },
    {
      ...
      desc: "From initial inquiry to final contract, we've streamlined the process to respect your time and urgency.",
      icon: Zap,
      color: "text-blue-400",
      bg: "bg-blue-500/10"
    },
    {
      ...
      desc: "Access a curated selection of world-class performers, from local legends to international stars.",
      icon: Globe,
    ...
    },
    {
      ...
      desc: "Your investment is protected by our transparent payment milestones and escrow-style security.",
      icon: HeartHandshake,
      color: "text-pink-400",
      bg: "bg-pink-500/10"
    },
    {
      title: "Elite Production Quality",
      desc: "We don't just book artists; we ensure the technical rider and production meet the highest standards.",
      icon: Trophy,
    ...
    },
    {
      ...
      desc: "Our dedicated booking managers handle every detail so you can focus on enjoying your event.",
      icon: Star,
                            ...
                            <div className="relative z-10 grid md:grid-cols-2 gap-10 items-center">
                                <div>
                                    ...
                                    <h3 className="text-3xl md:text-4xl font-extrabold text-white mb-5 leading-tight">
                                        ...
                                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 via-pink-500 to-purple-500 animate-gradient">When Stakes Are Highest</span>
                                    </h3>
