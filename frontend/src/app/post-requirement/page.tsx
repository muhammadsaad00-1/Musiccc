...
const ArtistTypeCard = ({
  ...
  >
    ...
    <span
      className={`text-sm font-medium ${selected ? "text-white" : "text-gray-400 group-hover:text-white"}`}
    >
      {label}
    </span>
    {selected && (
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-gray-400 text-sm">
                  Team reviews your requirements
                </span>
              </div>
              <div className="flex items-center gap-3">
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 relative">
        ...
        <div className="mb-10">
          <div className="flex items-center justify-between max-w-lg mx-auto relative">
            ...
            <div
              ...
              style={{
                width: `${((step - 1) / (totalSteps - 1)) * (100 - 10)}%`,
              }}
            />
        ...
        <form onSubmit={handleSubmit} className="relative">
          ...
          <div className="relative bg-[#111113]/95 backdrop-blur-xl rounded-3xl border border-gray-800/50 p-8 sm:p-10 shadow-2xl">
            ...
            <div
              className={`transition-all duration-300 ${step === 1 ? "opacity-100" : "hidden"} ${isAnimating ? "opacity-0 translate-x-4" : ""}`}
            >
            ...
            <div
              className={`transition-all duration-300 ${step === 2 ? "opacity-100" : "hidden"} ${isAnimating ? "opacity-0 translate-x-4" : ""}`}
            >
              <div className="flex items-center gap-3 mb-8">
            ...
            <div
              className={`transition-all duration-300 ${step === 3 ? "opacity-100" : "hidden"} ${isAnimating ? "opacity-0 translate-x-4" : ""}`}
            >
              <div className="flex items-center gap-3 mb-8">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    How much would you like to spend? (PKR)
                  </p>
                </div>
              </div>
            ...
            {/* Step 4: Contact Info */}
            <div
              className={`transition-all duration-300 ${step === 4 ? "opacity-100" : "hidden"} ${isAnimating ? "opacity-0 translate-x-4" : ""}`}
            >
              <div className="flex items-center gap-3 mb-8">
